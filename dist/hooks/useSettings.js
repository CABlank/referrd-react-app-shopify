    ...
    var handleChange = function (field, value) {
        setSettingsState(function (prevState) {
            ...
            return (__assign(__assign({}, prevState), { settings: prevState.settings
                    ? __assign(__assign({}, prevState.settings), (_a = {}, _a[field] = value, _a)) : __assign(__assign({}, initialSettings), (_b = {}, _b[field] = value, _b)) }));
        });
    };
    var handleSave = function () { return __awaiter(void 0, void 0, void 0, function () {
        var newSettings_1, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 6:
                    err_2 = _a.sent();
                    console.error("Error saving settings:", err_2);
                    setSettingsState(function (prevState) { return (__assign(__assign({}, prevState), { loading: false, error: "Failed to save settings. Please try again." })); });
                    return [3 /*break*/, 8];
                case 7:
