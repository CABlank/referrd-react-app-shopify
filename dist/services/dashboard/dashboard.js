...
export var fetchDashboardData = function (token, companyUUID // Assume you need companyUUID to fetch customers
) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, customersData, campaignsData, paymentsData;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), customersData = _a[0], campaignsData = _a[1], paymentsData = _a[2];
                return [2 /*return*/, {
