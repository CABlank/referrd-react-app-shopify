        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!response.ok) {
                        throw new Error("Failed to fetch ".concat(endpoint, ": ").concat(response.statusText));
                    }
...
export var fetchCustomers = function (token, companyUUID) {
    return fetchFromAPI("/items/customers?filter[company_id][_eq]=".concat(companyUUID), token);
};
// Fetch all companies
...
export var fetchCompanyByUUID = function (token, companyUUID) {
    return fetchFromAPI("/items/company?filter[UUID][_eq]=".concat(companyUUID), token);
};
// Fetch all campaigns
