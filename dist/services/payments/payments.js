...
// Fetch all referrals
export var fetchReferrals = function (token) {
    return fetchFromAPI("/items/referrals", token);
};
// Fetch all customers
export var fetchCustomers = function (token) {
    return fetchFromAPI("/items/customers", token);
};
// Fetch all campaigns
...
export var fetchReferralCodes = function (token) {
    return fetchFromAPI("/items/referral_codes", token);
};
// Fetch all payments
export var fetchPayments = function (token) {
    return fetchFromAPI("/items/payments", token);
};
// Update payment status
export var updatePaymentStatus = function (paymentId, status, token) {
    return fetchFromAPI("/items/payments/".concat(paymentId), token, {
        method: "PATCH",
