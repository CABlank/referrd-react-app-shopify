...
var duplicateCampaignToPublicPage = function (campaign, token, isUpdate) { return __awaiter(void 0, void 0, void 0, function () {
    var publicPageData, method, endpoint, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                publicPageData = {
                ...
                endpoint = isUpdate
                    ? "/items/campaign_public_page/".concat(campaign.id)
                    : "/items/campaign_public_page";
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, fetchFromAPI(endpoint, token, {
                        method: method,
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Failed to ".concat(isUpdate ? "update" : "create", " public page data"), error_1);
                return [3 /*break*/, 4];
...
// Duplicate campaign data to the public page collection
var duplicateCampaignToMetaData = function (campaign, token, isUpdate) { return __awaiter(void 0, void 0, void 0, function () {
    var publicPageData, method, endpoint, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                publicPageData = {
                ...
                method = isUpdate ? "PATCH" : "POST";
                endpoint = isUpdate
                    ? "/items/campaign_metadata/".concat(campaign.id)
            ...
            case 3:
                error_2 = _a.sent();
                console.error("Failed to ".concat(isUpdate ? "update" : "create", " public page data"), error_2);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, duplicateCampaignToPublicPage(createdCampaign, token, false)];
            case 2:
                // Duplicate the created campaign to the public page collection with the UUID
                _a.sent();
                // Duplicate the created campaign to the meta data collection with the UUID
                return [4 /*yield*/, duplicateCampaignToMetaData(createdCampaign, token, false)];
            case 3:
                // Duplicate the created campaign to the meta data collection with the UUID
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, duplicateCampaignToPublicPage(campaign, token, true)];
            case 2:
                // Duplicate the updated campaign to the public page collection
                _a.sent();
                // Duplicate the updated campaign to the meta data collection
                return [4 /*yield*/, duplicateCampaignToMetaData(campaign, token, true)];
            case 3:
                // Duplicate the updated campaign to the meta data collection
                _a.sent();
                return [3 /*break*/, 5];
            case 4:
                error_3 = _a.sent();
                console.error("Failed to update campaign", error_3);
                return [3 /*break*/, 5];
...
// Delete a campaign
export var deleteCampaign = function (id, token) { return __awaiter(void 0, void 0, void 0, function () {
    var error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetchFromAPI("/items/campaigns/".concat(id), token, {
                    method: "DELETE",
                })];
            case 1:
                _a.sent();
            ...
            case 2:
                _a.trys.push([2, 5, , 6]);
                return [4 /*yield*/, fetchFromAPI("/items/campaign_public_page/".concat(id), token, {
                        method: "DELETE",
                    })];
            case 3:
                _a.sent();
                return [4 /*yield*/, fetchFromAPI("/items/campaign_metadata/".concat(id), token, {
                        method: "DELETE",
                    })];
            case 4:
                _a.sent();
            ...
            case 5:
                error_4 = _a.sent();
                console.error("Failed to delete public page data", error_4);
                return [3 /*break*/, 6];
