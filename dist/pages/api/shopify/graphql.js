...
var handler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var sessionId, session, response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                // Reject anything that's not a POST
                if (req.method !== "POST") {
                    return [2 /*return*/, res.status(400).send({ text: "We don't do that here." })];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 5, , 6]);
            ...
            case 5:
                e_1 = _a.sent();
                console.error("An error occurred at /api/graphql", e_1); // Log the error
                return [2 /*return*/, res.status(403).send(e_1)]; // Respond with an error
