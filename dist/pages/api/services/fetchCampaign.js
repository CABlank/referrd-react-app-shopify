...
import { fetchCampaignMetadata } from "../utils/fetchCampaignMetadata";
import { validateCampaigns } from "../utils/validateCampaigns";
/**
 ...
 */
export function fetchCampaign(companyId, BOT_TOKEN) {
    return __awaiter(this, void 0, void 0, function () {
        var campaigns, validatedCampaign, campaign, format, API_URL, campaignData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchCampaignMetadata(companyId, BOT_TOKEN)];
                case 1:
                    campaigns = _a.sent();
                    validatedCampaign = validateCampaigns(campaigns);
                    if (!validatedCampaign) {
                        console.log("No valid campaign found");
                        return [2 /*return*/, null];
                    }
                    campaign = validatedCampaign.campaign, format = validatedCampaign.format;
                    console.log("Campaign Format:", format);
                    API_URL = process.env.API_URL || "";
                    return [4 /*yield*/, fetchCampaignData(campaign.id, API_URL, BOT_TOKEN)];
                case 2:
                    campaignData = _a.sent();
                    return [2 /*return*/, { campaign: campaign, format: format, campaignData: campaignData }];
            }
        });
    });
}
