...
var Settings = function (_a) {
    ...
    var _b = useSettings({
        ...
        userId: userId,
    }), settings = _b.settings, loading = _b.loading, error = _b.error, handleChange = _b.handleChange, handleSave = _b.handleSave;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, {
                        props: __assign(__assign({}, result.props), { title: "Settings" }),
                    }];
        }
    });
}); };
