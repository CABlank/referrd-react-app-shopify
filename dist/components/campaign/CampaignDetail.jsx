    ...
    return (<div className={"bg-white p-4 shadow rounded-lg border border-gray-200 ".concat(className)}>
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <input type="text" name="company" value={campaign.company} placeholder="Company name" className="w-full form-input px-4 py-2 border border-gray-300 rounded-md" onChange={handleChange}/>
        </div>
      </div>
    </div>);
};
