...
var ButtonElement = function (_a) {
    var buttonText = _a.buttonText, buttonLink = _a.buttonLink, _b = _a.buttonAlign, buttonAlign = _b === void 0 ? "center" : _b, onClick = _a.onClick, id = _a.id, props = __rest(_a, ["buttonText", "buttonLink", "buttonAlign", "onClick", "id"]);
    ...
    return (<button id={id} // Assign the realButtonId here
     type="button" style={inlineStyles} onClick={function (e) {
            e.preventDefault();
            if (onClick) {
                onClick();
            }
