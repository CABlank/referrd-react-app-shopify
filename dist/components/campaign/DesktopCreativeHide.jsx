...
var DesktopCreativeHide = function () {
    return (<div className="flex flex-col justify-center items-center w-[361px] relative gap-8 p-4 rounded-2xl bg-white">
      ...
      <svg width={329} height={1} viewBox="0 0 329 1" fill="none" xmlns="http://www.w3.org/2000/svg" className="self-stretch flex-grow-0 flex-shrink-0" preserveAspectRatio="xMidYMid meet">
        <line x1="0.25" y1="0.75" x2="328.75" y2="0.75" stroke="#B3B3B3" strokeWidth="0.5" strokeLinecap="round"/>
      </svg>
