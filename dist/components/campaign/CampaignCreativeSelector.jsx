...
var CampaignCreativeSelector = function (_a) {
    var className = _a.className, selectedFormat = _a.selectedFormat, onSelect = _a.onSelect;
    ...
    return (<div className={"bg-white p-6 shadow rounded-lg border border-gray-200 ".concat(className)}>
