...
var BarBuilder = forwardRef(function (_a, ref) {
    ...
    var _h = useState(true), isStepTwoAvailable = _h[0], setIsStepTwoAvailable = _h[1];
    ...
    var currentHeight = view === "desktop"
        ? previewStep === 1
    ...
    return (<DndProvider backend={HTML5Backend}>
        <div className={"flex ".concat(className)}>
          <div className="w-1/4 p-4 max-h-[750px] overflow-y-auto overflow-x-hidden">
            ...
            <DragAndDropSection />
            <CustomizationPanel view={view} elements={previewStep === 1
            ? view === "desktop"
                ? desktopStepOneElements
                : mobileStepOneElements
            : view === "desktop"
          ...
          <div className="w-3/4 p-4">
            ...
            <div ref={overflowRef} className="mt-4 custom-scrollbar overflow-x-auto overflow-y-hidden max-w-[980px] relative" style={{ height: "".concat(currentHeight) }}>
              <div ref={topBarPreviewRef}>
                <TopBarPreview key={key} ref={topBarPreviewRef} desktopStepOneElements={desktopStepOneElements} setDesktopStepOneElements={setDesktopStepOneElements} mobileStepOneElements={mobileStepOneElements} setMobileStepOneElements={setMobileStepOneElements} desktopStepTwoElements={desktopStepTwoElements} setDesktopStepTwoElements={setDesktopStepTwoElements} mobileStepTwoElements={mobileStepTwoElements} setMobileStepTwoElements={setMobileStepTwoElements} view={view} desktopConfigStepOne={desktopConfigStep1} desktopConfigStepTwo={desktopConfigStep2} mobileConfigStepOne={mobileConfigStep1} mobileConfigStepTwo={mobileConfigStep2} step={previewStep} setUrl={setPreviewUrl} url={previewUrl} setStep={setPreviewStep} allowStepChange={true} isStepTwoAvailable={isStepTwoAvailable} enableDragAndDrop={true} forceMobileView={view === "mobile"}/>
              </div>
            </div>
          </div>
        </div>
