...
var MobileCustomizationPanel = function (_a) {
    ...
    return (<div className="p-4 bg-white rounded-lg mb-4">
      ...
      {elements.map(function (element) {
          ...
          <div className="flex justify-between items-center cursor-pointer p-2 bg-white mb-4" onClick={function () { return element && toggleElement(element.id); }}>
          ...
          {openElementId === (element === null || element === void 0 ? void 0 : element.id) &&
                ...
                {(_a = fieldConfigs[element === null || element === void 0 ? void 0 : element.type]) === null || _a === void 0 ? void 0 : _a.map(function (field) { return (<FormField key={field.name} label={field.label} name={field.name} type={field.type} value={getFieldValue(element, field.name)} onChange={function (e) { return handleChange(e, element); }} onBatchChange={field.type === "margin" || field.type === "padding"
