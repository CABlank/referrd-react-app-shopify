      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <select name="commissionType" value={campaign.commissionType || ""} className="w-full h-10 px-4 py-2 border border-gray-300 rounded-md bg-white text-gray-700" onChange={handleChange}>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center h-10 border border-gray-300 rounded-md bg-white">
              ...
              <input type="text" name="commission" value={campaign.commission || ""} placeholder="Commission" className="flex-1 px-2 py-2 bg-transparent text-gray-700" onChange={handleChange}/>
            </div>
          </div>
        </div>
