...
var PaymentForm = function (_a) {
    var campaignId = _a.campaignId, amountFunded = _a.amountFunded, oldAmount = _a.oldAmount;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, fetch("/api/create-checkout-session", {
                            ...
                            body: JSON.stringify({ amountFunded: amountFunded, campaignId: campaignId, token: token, oldAmount: oldAmount }),
                        })];
                case 3:
                    response = _a.sent();
    ...
    return (<form onSubmit={handlePayment}>
      <button type="submit" disabled={!stripe || loading} className="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 h-10 relative gap-2 px-4 py-2 rounded-lg bg-[#47b775]">
        Submit Amount
      </button>
    </form>);
};
