...
var RegisterForm = function () {
    ...
    var handleGoogleRegister = function () {
        var expectedRedirectUri = "http://localhost:3000/auth/google";
        var directusOAuthURL = "http://localhost:8055/auth/login/google?redirect=".concat(encodeURIComponent(expectedRedirectUri));
    ...
    return (<form className="flex flex-col justify-start self-stretch flex-grow-0 flex-shrink-0 gap-4 px-8" onSubmit={handleRegister}>
     ...
     onClick={handleGoogleRegister} className="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 h-12 relative gap-2 px-4 py-2 rounded-lg bg-[#851087]/5">
        <GoogleIcon />
