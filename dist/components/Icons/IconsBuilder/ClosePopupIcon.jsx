...
var ClosePopupIcon = function () {
    return (<div className="bg-black rounded-full p-0.5 flex justify-center items-center w-5 h-5 absolute left-[560px] top-4 z-10 cursor-pointer">
      <svg width={16} height={16} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" preserveAspectRatio="none">
