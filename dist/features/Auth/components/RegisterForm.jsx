...
import ShopifyPurpleIcon from "../../../components/Icons/ShopifyPurpleIcon";
import ShopifyGreenIcon from "../../../components/Icons/ShopifyGreenIcon";
import WorkEmailPurpleIcon from "../../../components/Icons/WorkEmailPurpleIcon";
      ...
      {registerMethod === "email" ? (<>
          ...
          <div className="flex flex-col items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2">
            ...
            <div className="flex justify-between items-center self-stretch flex-grow-0 flex-shrink-0 h-12 relative px-8 py-2 rounded-lg bg-white border-[0.5px] border-black/30">
              <ShopifyGreenIcon />
              <input type="text" value={formData.shopifyStoreUrl} onChange={function (e) {
                return handleChange("shopifyStoreUrl", e.target.value);
            }} placeholder="your-store" className="flex-grow-1 flex-shrink-0 text-base text-left text-[#7f7f7f]"/>
          ...
          <button type="button" onClick={function () {
                return handleOAuthRegister("https://yourshopifyapp.com/auth/shopify?shop=".concat(formData.shopifyStoreUrl, ".myshopify.com"));
