...
const BottomNavigationBar: React.FC<BottomNavigationBarProps> = ({
  ...
  useEffect(() => {
    document.body.setAttribute(
      "data-current-substep",
      currentSubStep.toString()
    );
  }, [currentSubStep]);
  ...
  const stepMessages: { [key: string]: string } = {
    ...
    "4-1":
      "Customize your Popup for Desktop - Step 1. Set up height, width, and design elements.",
    "4-2":
      "Customize your Popup for Desktop - Step 2. Finalize design for desktop.",
    "4-3":
      "Customize your Popup for Mobile - Step 1. Set up form fields and other elements.",
    "4-4":
      "Customize your Popup for Mobile - Step 2. Add final adjustments for mobile devices.",
    "4-5":
      "Customize your Top Bar for Desktop - Step 1. Configure the layout and call to action.",
    "4-6":
      "Customize your Top Bar for Desktop - Step 2. Add sharing icons and finalize content.",
    "4-7":
      "Customize your Top Bar for Mobile - Step 1. Configure the layout and call to action.",
    "4-8":
      "Customize your Top Bar for Mobile - Step 2. Finalize design for mobile.",
    "5": "Review your campaign details and publish it to make it live.",
  };

  const currentStepKey =
    currentStep === 4 ? `4-${currentSubStep}` : currentStep.toString();
  const currentStepMessage =
    stepMessages[currentStepKey] || "Complete this step to proceed.";
