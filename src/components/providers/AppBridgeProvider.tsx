...
import React, { ReactNode, useEffect, useState } from "react"; // Import necessary modules from React
...
const AppBridgeProvider: React.FC<AppBridgeProviderProps> = ({ children }) => {
  const [shop, setShop] = useState<string | null>(null); // Set up state to store the shop domain
