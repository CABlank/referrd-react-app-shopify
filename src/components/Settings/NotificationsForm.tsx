  ...
  <div className="flex flex-col justify-start items-start flex-grow gap-8 p-8 rounded-2xl bg-white shadow-lg w-full ">
    ...
    <div className="flex flex-col items-start gap-4 w-full">
      <NotificationToggle
        ...
        onChange={() =>
          handleChange(
            "notify_referral_conversions",
            !settings?.notify_referral_conversions
          )
        }
      />
      <NotificationToggle
        ...
        onChange={() =>
          handleChange(
            ...
            !settings?.notify_payment_confirmation
          )
        }
      />
      <NotificationToggle
        ...
        onChange={() =>
          handleChange(
            "notify_payment_notifications",
            !settings?.notify_payment_notifications
          )
        }
      />
      <NotificationToggle
        ...
        onChange={() =>
          handleChange(
            "no_payment_notifications",
            !settings?.no_payment_notifications
          )
        }
      />
    </div>
