...
import BottomNavigationBar from "../../../components/campaign/BottomNavigationBar";
...
const EditCampaign: React.FC<CampaignEditProps> = ({ accessToken, refreshToken, userId }) => {
  ...
  const handlePaymentSuccess = async () => {
    try {
      ...
      console.log("Payment was successful, and campaign data has been updated.");
    } catch (error) {
  ...
  console.log("barBuilderRef", barBuilderRef);
  console.log("popupBuilderRef", popupBuilderRef);
